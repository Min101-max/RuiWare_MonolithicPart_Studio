...
export const api = {
  ...
  completeStage: (id: string, stage: StageName, baseRevision: number) => request<StageActionResult>(`/api/v1/template-drafts/${id}/stages/${stage}/complete`, json("POST", { baseRevision })),
